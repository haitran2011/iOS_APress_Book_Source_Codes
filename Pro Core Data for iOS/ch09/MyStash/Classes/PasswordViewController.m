...
- (IBAction)save:(id)sender {
  ...
  // Create variables to store pre-change state, so we can back out if validation errors occur
  ...
  if (parentController != nil) {
    if (system != nil) {
      ...
      // User is adding a new system. Create the new managed object but keep a pointer to it
