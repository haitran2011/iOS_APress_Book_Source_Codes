...
{
	@synchronized (defaultManageObjectContext)
	{
...
+ (NSManagedObjectContext *) newContextWithStoreCoordinator:(NSPersistentStoreCoordinator *)coordinator
{
...
{
	return [self newContextWithStoreCoordinator:[NSPersistentStoreCoordinator defaultStoreCoordinator]];
}
